...
class InceptionI3d(nn.Module):
    ...
    def __init__(self, name='modified_inception_i3d', final_endpoint='Mixed_5c', in_frames=8, in_channels=3,
                 pretrained=True, weights_path='/home/namanb/Desktop/UCF_work/models/rgb_charades.pt'):
        """
        ...
        if in_frames == 8:
            ...
            self.end_points[end_point] = MaxPool3dSamePadding(kernel_size=[2, 3, 3], stride=(1, 1, 1),
                                                              padding=0)
    ...
    def forward(self, x):
        ...
        return return_features  # returns 256x8x28x28, 256x4x14x14
        # return x
