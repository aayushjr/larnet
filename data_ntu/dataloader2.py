...
class NTUDataset(Dataset):
    ...
    def __init__(self, root_dir, data_file, param_file=None, caption_file = "caption.txt"
                 resize_height = 56, resize_width = 56, clip_len = 16,
                 height=64, width=64, skip_len=2,
